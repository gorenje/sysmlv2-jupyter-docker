...
Each release has it's own branch, so for example to test the [SysML v2 Release 2020-10](https://github.com/Systems-Modeling/SysML-v2-Release/releases/tag/2020-10), do the following:

```
git checkout release-2020-10
make run-hub
```

That will locally start DockerHub Jupyter image with the 2020-10 release.
